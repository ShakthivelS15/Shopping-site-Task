  ...
  return (
    <>
        ...
        <Row className="w-100">
          <Col xs={12} md={3} className="mb-4">
            <div className="d-flex align-items-center">
              <Truck className="icon1 me-3" size={30} />
              <div>
          ...
          <Col xs={12} md={3} className="mb-4">
            <div className="d-flex align-items-center">
              <Wallet2 className="icon1 me-3" size={30} />
              <div>
          ...
          <Col xs={12} md={3} className="mb-4">
            <div className="d-flex align-items-center">
              <ShieldLock className="icon1 me-3" size={30} />
              <div>
      ...
      <section>
        <Row className="align-items-center">
          <Col xs={12} lg={4} className="">
            <img src={men} className="img-fluid" alt="For Men's" />
          </Col>
          <Col xs={12} lg={8}>
            <Row className="">
              ...
              <Col md={12} className="menof ">
                <img src={men1} className="img-foot mx-1 my-2 menimg" alt="foot1" />
                <img src={men2} className="img-foot mx-1 my-2 menimg" alt="foot1" />
                <img src={men3} className="img-foot mx-1 my-2 menimg" alt="foot1" />
              </Col>
      ...
      <section>
        <Row>
          <div className='offer'>
            <Col md={4} className='input'>
              <div class="input-group">
                <input type="text" class="form-control clo" placeholder="Sign up" />
