...
import moster from '../images/footermoster.png'
import footsvisa from '../images/footsvisa.png'
import './footer.css';
        ...
        <div className='bg-img'>
            <Row className='HEADER'>
                <Col md={3} className='ft-text'>
                    ...
                    <div className='mt-3'>   <JournalMedical className="icon icons" /> <span className='ft-footer-p'> Buford, GA 21346 USA </span></div>
                    <div className='mt-3'>   <Telephone className="icon icons" /> <span className='ft-footer-p'> (800) 555-0175</span> </div>
                    <div className='mt-3'>   <EnvelopeOpen className="icon icons " /> <span className='ft-footer-p'> tobysboutique@gmail.com </span>  </div>
                </Col>
                <Col md={3} className='ft-text '> INFORMATION
                    <div className='line'> </div>
                ...
                <Col md={3} className='ft-text '> NEED HELP <div className='line'> </div>
                    ...
                    <div className='ft-footer-p mt-3'>International
                        →
                        Contact </div>
                </Col>
                <Col md={3} className='ft-text'> NEWSLETTER   <div className='line'> </div>
